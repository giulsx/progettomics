...
# Carica il file JSON
json_file_path = "progetto mics/ecoinvent-3.10-cutoff-lci-15352.json"
try:
...
id_file_path = "progetto mics/output_id_counts_greater_than_one_LCI.txt"
...
output_file_path = "progetto mics/output_id_texts_LCI.txt"
try:
