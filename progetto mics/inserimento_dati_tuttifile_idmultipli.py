...
def populate_intermediate_exchange_table(cursor, activity_data, activity_id):
    ...
    if reference_product:
        ...
        activity_id_original = activity_data.get("@id", "")
        activity_product_id = f"{activity_id_original}_{intermediate_exchange}"  # Creazione dell'activityId_productId
...
# Percorsi
directory_path = os.path.abspath("progetto mics/output multipli")
